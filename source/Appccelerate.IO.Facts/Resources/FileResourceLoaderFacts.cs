//-------------------------------------------------------------------------------
// <copyright file="FileResourceLoaderFacts.cs" company="Appccelerate">
...
namespace Appccelerate.IO.Resources
{
    ...
    public class FileResourceLoaderFacts
    {
        /// <summary>
        ...
        public FileResourceLoaderFacts()
        {
            this.testee = new FileResourceLoader();
            this.resourceLoader = new EmbeddedResourceLoader();
            this.filepath =
                Path.Combine(Path.GetDirectoryName(typeof(FileResourceLoaderFacts).Assembly.Location), FileName);
        }
        ...
        {
            Stream expected = this.resourceLoader.LoadResourceAsStream(typeof(FileResourceLoaderFacts), XmlResourceName);

            using (new TemporaryFileHolder(this.filepath, expected))
            {
                Stream resource = this.testee.LoadResourceAsStream(typeof(FileResourceLoaderFacts).Assembly, FileName);
        ...
        public void LoadResourceAsStreamFromType()
        {
            ...
            using (new TemporaryFileHolder(this.filepath, expected))
            {
                Stream resource = this.testee.LoadResourceAsStream(typeof(FileResourceLoaderFacts), FileName);
        ...
        {
            string expected = this.resourceLoader.LoadResourceAsString(typeof(FileResourceLoaderFacts), TextResourceName);
            using (new TemporaryFileHolder(this.filepath, expected))
            {
                string resource = this.testee.LoadResourceAsString(typeof(FileResourceLoaderFacts).Assembly, FileName);
        ...
        public void LoadResourceAsStringFromType()
        {
            ...
            using (new TemporaryFileHolder(this.filepath, expected))
            {
                string resource = this.testee.LoadResourceAsString(typeof(FileResourceLoaderFacts), FileName);
                Assert.Equal(expected, resource);
            }
        }
        ...
        {
            Stream resourceStream = this.resourceLoader.LoadResourceAsStream(typeof(FileResourceLoaderFacts), XmlResourceName);

            using (new TemporaryFileHolder(this.filepath, resourceStream))
            {
                IXPathNavigable expected = this.resourceLoader.LoadResourceAsXml(typeof(FileResourceLoaderFacts), XmlResourceName);
                IXPathNavigable resource = this.testee.LoadResourceAsXml(typeof(FileResourceLoaderFacts).Assembly, FileName);
        ...
        public void LoadResourceAsXmlFromType()
        {
            ...
            {
                IXPathNavigable expected = this.resourceLoader.LoadResourceAsXml(typeof(FileResourceLoaderFacts), XmlResourceName);
                IXPathNavigable resource = this.testee.LoadResourceAsXml(typeof(FileResourceLoaderFacts), FileName);
