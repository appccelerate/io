//-------------------------------------------------------------------------------
// <copyright file="StreamDecoratorStreamPropertiesFacts.cs" company="Appccelerate">
...
namespace Appccelerate.IO.Streams
{
    ...
    public class StreamDecoratorStreamPropertiesFacts
    {
        ...
        public StreamDecoratorStreamPropertiesFacts()
        {
